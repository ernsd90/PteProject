                    ...
                    <div className="row">
                        ...
                        <div className="inner">
                            ...
                            <h2 className="title color-white">
                                <span className="theme-gradient">Complete guideline</span> from
                            ...
                            <div className="col-lg-12">
                                ...
                                <div className="inner">
                                    ...
                                    <h2 className="title mt--10">
                                        Complete app development course with HiStudy
                                    </h2>
                                    <p>
                                        The idea of establishing a private university to provide
                                        quality education at an affordable cost in Uk London.
                                    </p>
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="inner">
                                    ...
                                    <div className="content">
                                    <h2 className="title">Get a Certificate</h2>
                                    <p>
                                        Apply for Admission in Post Graduate Diploma.
                                        Application Deadline: 26th September year Undergraduate.
                                    </p>
                                    <ul className="course-feature-list">
                                        <li>
                                        <div className="icon">
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="inner">
                                    ...
                                    <div className="swiper modern-course-carousel-activation rbt-arrow-between">
                                    ...
                                    <div className="content">
                                    <h2 className="title">Projects You Will Build</h2>
                                    <p>
                                        Apply for Admission in Post Graduate Diploma.
                                        Application Deadline: 26th September year Undergraduate.
                                    </p>
                    ...
                    <div className="row gy-5 row--30">
                        ...
                        <div className="course-content">
                            ...
                            <div className="accordion" id="accordionExampleb2">
                                ...
                                >
                                    ...
                                    <ul className="rbt-course-main-content liststyle">
                                        ...
                                        <a href="#">
                                            ...
                                            <div className="course-content-right only-lock">
                                ...
                                <div className="accordion-item card">
                                <h2 className="accordion-header card-header" id="headingTwo8">
                                    <button
                                    className="accordion-button collapsed"
                                    type="button"
                                    data-bs-toggle="collapse"
                                ...
                                <div className="accordion-item card">
                                <h2 className="accordion-header card-header" id="headingTwo9">
                                    <button
                                    className="accordion-button collapsed"
                                    type="button"
                                    data-bs-toggle="collapse"
                ...
                <div className="rbt-pricing-area bg-color-white rbt-section-gapBottom">
                    ...
                    <div className="row g-5 mb--60">
                        ...
                        <div className="section-title text-center">
                            ...
                            See this our three main plans for our histudy courses. It starts
                            from here! You can teach yourself what you really like.
                            </p>
                        </div>
                        </div>
                    </div>
                        ...
                        <div className="media row align-items-center g-5">
                            ...
                            <div className="media-body ml--15">
                                ...
                                <p className="description color-white">
                                    ...
                                    encountered a lot of obstacles and was forbidden to work in
                                    this field by her family. With a true spirit and talented
                                    gift, she was able to succeed and set an example for others.
                                </p>
